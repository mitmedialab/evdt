...
# =============================================================================
    ...
    shapefilepaths = ['./FormatedShapefiles/Bairros_with_Population.shp', './FormatedShapefiles/Mangroves/mangrovelossshape.shp']
...
# =============================================================================
    ...
    def make_map_window(self, root):
        ...
        mapimg = MapWindow.Map(frame_map,self.shape_bairros,background_image=self.map_base)
