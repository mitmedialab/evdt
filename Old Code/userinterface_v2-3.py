...
# =============================================================================
    ...
    def make_layer_buttons(self, root):
        ...
        zoombutton.grid(column=4, row=0, ipadx=gridpadding)
        zoomentry = tk.Entry(frame_layer)
        zoomentry.grid(column=4, row=1, ipadx=gridpadding)
        zoomlabel = tk.Label(frame_layer, 
                             text = '%',
                             font=('Arial',14))
        zoomlabel.grid(column=5, row=1, ipadx=gridpadding)
                               
        
        #Return frame for future reference
        return frame_layer
