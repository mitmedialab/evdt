...
#Define filepaths and shapefile fields of interest
    ...
    zonefilepaths = ['./FormatedShapefiles/Bairros/Bairros_Custom_restricted.shp']
    shape_zones = []
...
# =============================================================================
    ...
    def replace_map_image(self):
        ...
        self.mangrovesetting.set(self.MangroveModes[self.mangroveoptionvar.get()])
    ...
    def print_coords(self, event):
        ...
        for shaperec in self.zone_default.iterShapeRecords():
            ...
            if shapely.geometry.Point((geox, geoy)).within(shapely.geometry.shape(boundary)): # make a point and see if it's in the polygon
                ...
                area_of_loss = 0;
                for shaperec in self.shape_mangroves[1].iterShapeRecords():
...
# =============================================================================
    ...
    def calculations(self, root):
        ...
        """
        self.shape_mangroves_present = self.shape_mangroves
        self.shape_mangroves_future = []
        self.shape_mangroves_future.append(self.shape_mangroves[0])
        self.shape_mangroves_future.append(self.shape_mangroves[1])

        self.shape_zones_present = self.shape_zones
        self.shape_zones_future = self.shape_zones
        
        self.mangrovehealth_future = FutureCalculations.mangrovehealthchange(self, self.shape_zones[0], self.shape_mangroves[2])
        self.shape_mangroves_future.append(self.mangrovehealth_future)
    ...
    def show_future(self):
        ...
        if self.tense == 0:
            ...
            self.shape_mangroves = self.shape_mangroves_future
            self.shape_zones = self.shape_zones_future
            self.replace_map_image()
            ...
            self.shape_mangroves = self.shape_mangroves_present
            self.shape_zones = self.shape_zones_present
            self.replace_map_image()
