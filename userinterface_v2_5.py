...
# =============================================================================
    ...
    #Define filepaths and shapefile fields of interest
        ...
        if 'uoa' in kwargs:
            ...
            default_uoa_filepaths = ['./FormatedShapefiles/Bairros/Bairros_Custom_restricted_DEFAULT.shp',
        ...
        #MAP IMAGES
        if 'mapimgs' in kwargs:
            mapimgs = kwargs.pop('mapimgs')
            map_filepaths = mapimgs[0]
            map_names = mapimgs[1]
        else:
            map_filepaths = [[], "./Map Images/basemap.png" ]
            map_names  = ["Nenhum",
                          "Mapa Base"
                          ]
        ...
        if 'overlay' in kwargs:
            ...
            overlay_filepaths = overlay[0]
            overlay_colors = overlay[1]
            overlay_color_titles = overlay[2]
            overlay_names = overlay[3]
        else:
            overlay_filepaths = [ [], './FormatedShapefiles/Mangroves/m_loss.shp', 
            ...
            overlay_names = ["Nenhum",
                             "Perda de Manguezais",
                             "Saúde dos Manguezais"
                             ]
        ...
        self.uoa = MapType(uoa_filepaths, 
                           default = 1,
                           names = uoa_names,
                           color_default = ['Nenhum', 'Nenhum', 'Nenhum', 'Nenhum'],
                           original_filepaths = default_uoa_filepaths, 
                           maptype='shp')
        ...
        self.overlay = MapType(overlay_filepaths,
                               names = overlay_names,
                               default = 0,
...
# =============================================================================
    ...
    def make_layer_buttons(self, root):
        ...
        self.uoa.names.insert(0, [])
        self.uoa.longname_modes_inverted = dict(list(enumerate(self.uoa.names)))
        del self.uoa.longname_modes_inverted[0]

        self.uoa.longname_modes = dict(map(reversed, self.uoa.longname_modes_inverted.items()))
        ...
        self.map_image.longname_modes_inverted = dict(list(enumerate(self.map_image.names)))
        self.map_image.longname_modes = dict(map(reversed, self.map_image.longname_modes_inverted.items()))
        ...
        self.overlay.longname_modes_inverted = dict(list(enumerate(self.overlay.names)))
        self.overlay.longname_modes = dict(map(reversed, self.overlay.longname_modes_inverted.items()))
